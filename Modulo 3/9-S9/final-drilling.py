# FILTRANDO DATOS INSTRUCCIONES
# Lee con atencióncada uno de los requerimientos que se presentan a continuación,
# y desarrolla la pruebade acuerdo conlo solicitado.DESCRIPCIÓN Dada la siguiente
# lista de nombres:
# •Harry Houdini
# •Newton
# •David Blaine
...
# llamada hacer_grandioso(), que  modifique  la  lista  de  magos  añadiendo  la frase
# ‘El gran‘ antes del nombre de cada mago.
# Crear  una  función  llamada imprimir_nombres(),  que  imprime  el  nombre  de  cada personade  la lista.
# Finalmente, imprimiren  pantalla  la  lista completa  de  nombresantes  de  ser  modificados;
