...
# getters and setters son fucniones para obtener o dar valor a los atributos
#getters
...
# Vehiculo de marca Mazda esta en encendido a una velocidad de 10
print(mazda.arrancar())
# Vehiculo de marca Mazda ha aumentado su velocidad en 10 y la velocidad actual es 20
...
# Vehiculo de marca Toyota ya se encuentra en encendido, no se puede volver a arrancar
print(toyota.arrancar())
# Vehiculo de marca Toyota ha aumentado su velocidad en 10 y la velocidad actual es 10
print(toyota.acelerar())
print(toyota.frenar())  # vehiculo de marca Toyota y Yaris esta frenando


# get obteener el valor del atributo a traves de notacion de puntos
print(mazda.color)
